...
echo -e ""
    ...
    echo -e "
                ...
                ————————————————————————————————                                                                ————————————————————————————————
                      1. Phiên Bản 1.5.5                                                                              15. Phiên Bản 1.2.4
                ————————————————————————————————                                                                ————————————————————————————————
                      2. Phiên Bản 1.5.4                                                                              16. Phiên Bản 1.2.3
                ————————————————————————————————                                                                ————————————————————————————————
                      3. Phiên Bản 1.5.3                                                                              17. Phiên Bản 1.2.2
                ————————————————————————————————                                                                ————————————————————————————————
                      4. Phiên Bản 1.5.2                                                                              18. Phiên Bản 1.2.1
                ————————————————————————————————                                                                ————————————————————————————————
                      5. Phiên Bản 1.5.1                                                                              19. Phiên Bản 1.2.0
                ————————————————————————————————                                                                ————————————————————————————————
                      6. Phiên Bản 1.5.0                                                                              20. Phiên Bản 1.1.2
                ————————————————————————————————                                                                ————————————————————————————————
                      7. Phiên Bản 1.4.3                                                                              21. Phiên Bản 1.1.1
                ————————————————————————————————                                                                ————————————————————————————————
                      8. Phiên Bản 1.4.2                                                                              22. Phiên Bản 1.1.0
                ————————————————————————————————                                                                ————————————————————————————————
                      9. Phiên Bản 1.4.1                                                                              23. Phiên Bản 1.0.3
                ————————————————————————————————                                                                ————————————————————————————————
                     10. Phiên Bản 1.4.0                                                                              24. Phiên Bản 1.0.2
                ————————————————————————————————                                                                ————————————————————————————————
                     11. Phiên Bản 1.3.2                                                                              25. Phiên Bản 1.0.1
                ————————————————————————————————                                                                ————————————————————————————————
                     12. Phiên Bản 1.3.1                                                                              26. Phiên Bản 1.0.0
                ————————————————————————————————                                                                ————————————————————————————————
                     13. Phiên Bản 1.3.0                                                                              27. Phiên Bản 0.1.0
                ————————————————————————————————                                                                ————————————————————————————————
                     14. Phiên Bản 1.2.5                                                                              28. Quay Lại
                ————————————————————————————————                                                                ————————————————————————————————"
